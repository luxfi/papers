...
\item \textbf{Quantum-safe auth}: Dual-certificate signatures (BLS + Corona)
...
\item \textbf{Corona}: Lattice-based post-quantum, 1,024-byte signatures
\item \textbf{Transition}: Hybrid mode (2025-2027), pure Corona (2027+)
\end{itemize}
...
\bibitem{corona}
Lux Industries, Inc., ``Corona: Lattice-Based Threshold Signatures,'' \textit{LP-99}, 2025.
