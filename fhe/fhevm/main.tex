...
Microsoft SEAL~\cite{seal}, OpenFHE~\cite{openfhe}, and TFHE-rs~\cite{tfhe-rs} provide FHE libraries but no blockchain integration.
...
\paragraph{Prior fhEVM Work}
Zama's fhEVM~\cite{zama-fhevm} pioneered on-chain FHE; we extend with threshold decryption and additional optimizations.
