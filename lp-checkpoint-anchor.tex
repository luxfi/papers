...
in the Lux precompile registry (Privacy/Encryption page, item 0x10; item
0x00 was reclaimed by the pre-existing \texttt{fhe} precompile).
\end{abstract}
...
in the LP addressing scheme; item 0x00 is occupied by the pre-existing
\texttt{fhe} precompile). It exposes four functions via ABI selector:
