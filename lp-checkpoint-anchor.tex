...
implemented as a stateful EVM precompile at address \texttt{0x0700} in the
Lux precompile registry (Privacy/Encryption page, item 0x00).
\end{abstract}
...
\texttt{0x0700} (Privacy/Encryption page, C-Chain slot, item 0x00 in the
LP addressing scheme). It exposes four functions via ABI selector:
