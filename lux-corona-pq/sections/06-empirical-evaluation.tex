...
\bottomrule
\end{tabular}
\caption{Pulsar performance benchmarks}
...
\textbf{Pulsar} & \textbf{56 KB} & \textbf{600ms} & \textbf{0.8ms} & \textbf{Yes} \\
\bottomrule
\end{tabular}
...
Pulsar's signature is $\sim 1000\times$ larger than classical schemes, but this is
