...
Corona~\cite{lux-corona} is a lattice-based (Module-LWE, Ringtail-derived) threshold signature scheme with an anonymity property: the verifier can confirm that a threshold of validators signed, but cannot determine \textit{which} validators participated.
