...
\subsection{Proof 3: Pulsar Threshold Signature (Post-Quantum Privacy)}

Pulsar is a lattice-based (Ring-LWE) threshold signature scheme with an anonymity property: the verifier can confirm that a threshold of validators signed, but cannot determine \textit{which} validators participated.
