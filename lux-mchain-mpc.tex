...
\section{Concrete Security Analysis (March 2026 Revision)}
...
\bottomrule
\end{tabular}
\caption{Concrete forgery probability per threshold scheme}
...
This is computed via the exact binomial CDF. The expected available nodes $\mu = 99.9$ exceeds the threshold by $32.9$ nodes, providing substantial headroom. See Appendix of the companion Lux Bridge paper \cite{lux-bridge-2026} for the full derivation.
