...
At Lux's 1\,B gas block limit (\num{47619} txs/block), GPU-BLS opcode dispatch yields a
\textbf{\num{4761904}\,TPS execution-only upper bound}---\emph{not} an end-to-end finality
figure; finality is bound by signature recovery, settlement conflict-detection, and BLS/PQ
finality. CPU BLS provides a 100\,ms fallback (\num{476190}\,TPS execution-only). At 100 validators over WAN, consensus-layer throughput reaches
...
\bibitem{pulsar}
Z.~Kelling. (2026).
\textit{LP-073: Pulsar --- Module-LWE Rank-$k$ Threshold ML-DSA for
Permissionless Validator Sets}.
Lux Industries, Inc. \texttt{github.com/luxfi/pulsar}.
...
\url{https://atrium.lib.uoguelph.ca/items/5459099e-67aa-4a83-b816-25c6752e0afe}

\bibitem{cometbftgithub}
CometBFT Authors. (2026).
\textit{CometBFT: A distributed, Byzantine fault-tolerant, deterministic state machine replication engine}.
\url{https://github.com/cometbft/cometbft}

\bibitem{malkhi2023hotstuff2}
Malkhi, D., Nayak, K. (2023).
\textit{HotStuff-2: Optimal Two-Phase Responsive BFT}.
Cryptology ePrint Archive 2023/397.
...
\bibitem{amores2024avalanche}
Amores-Sesar, I., Schneider, P., Cachin, C. (2024).
\textit{An Analysis of Avalanche Consensus}.
arXiv:2401.02811.

\bibitem{babel2024mysticeti}
Babel, K., Danezis, G., Kokoris-Kogias, E., Sonnino, A. (2025).
\textit{Mysticeti: Reaching the Limits of Latency with Uncertified DAGs}.
NDSS 2025. arXiv:2310.14821.

\bibitem{alqahtani2021bottlenecks}
Alqahtani, S., Demirbas, M. (2021).
\textit{Bottlenecks in Blockchain Consensus Protocols}.
arXiv:2103.04234.
...
Yin, M., Malkhi, D., Reiter, M.K., Gueta, G.G., Abraham, I. (2019).
\textit{HotStuff: BFT Consensus with Linearity and Responsiveness}.
ACM PODC 2019. arXiv:1803.05069.
