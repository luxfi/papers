...
The encrypted result $\tilde{y}$ is decrypted via a $(k, n)$-threshold scheme managed by the F-Chain. The agent's FHE secret key is secret-shared among $n$ F-Chain validators using Shamir's Secret Sharing:
