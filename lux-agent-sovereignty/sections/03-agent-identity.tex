...
\begin{itemize}
    \item \textbf{Verification methods.} Public keys for authentication, assertion, key agreement, and capability invocation. Post-quantum keys (ML-DSA) are included alongside classical (Ed25519) for crypto-agility.
