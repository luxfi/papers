...
Encrypted memory can be processed by external compute nodes without decryption. The agent (or a threshold set of authorized parties via M-Chain) holds the decryption key.
