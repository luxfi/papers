...
\begin{lstlisting}[language=Java, caption=Witness Data Structure]
struct WitnessData {
...
\begin{lstlisting}[language=Java, caption=Lux Fraud Proof Manager]
...
\begin{lstlisting}[language=Java, caption=Warp Message Verification]
...
\begin{lstlisting}[language=Java, caption=Protocol Message Structures]
