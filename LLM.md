...
- **S4 Cryptographic Layers**: BLS12-381, Ringtail (Ring-LWE threshold), ML-DSA-65.
- **S5 Chain Separation** (added 2026-04-13): X=verify, Q=Ringtail consensus, T=all MPC, Z=Groth16 of ML-DSA. Table~2.
...
- **S7 Security Analysis**: Safety (Thm~7.1), Liveness (Thm~7.2), Unforgeability (Thm~7.3), Single-Compromise (Thm~7.4).
  ...
  - **S7.7 Post-Quantum Safety** (added 2026-04-13): Thm~7.7. If co-CDH falls to Shor, Ringtail + ML-DSA suffice. Explicit hybrid reduction.
- **S8 Performance**: BLS 371us, ML-DSA 504us, Ringtail 2-round, ZAP wire protocol.
