...
The ATS is implemented as a single Go binary (\texttt{liquidityio/ats}) running on Hanzo Base. Hanzo Base provides an embedded SQLite-compatible database with real-time subscriptions, authentication, and file storage. The binary packages all ATS functionality into a single deployable unit.
