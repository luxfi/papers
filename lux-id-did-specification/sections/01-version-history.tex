...
\begin{itemize}[leftmargin=*]
  ...
  \item \textbf{v2025.10} (October 2025): \textbf{Current revision} — Post-quantum credentials (ML-DSA (FIPS 204, formerly CRYSTALS-Dilithium)), enhanced hardware security key support, full Lux ecosystem integration
\end{itemize}
