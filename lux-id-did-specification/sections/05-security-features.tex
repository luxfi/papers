...
\begin{itemize}
  \item \textbf{ML-DSA (FIPS 204, formerly CRYSTALS-Dilithium)} \cite{dilithium}: Digital signatures (NIST PQC standard)
    \begin{itemize}
      \item Public key: 1,952 bytes
      \item Signature: 3,293 bytes
      \item Security: NIST Level 3 (equivalent to AES-192)
    \end{itemize}
  \item \textbf{ML-KEM (FIPS 203, formerly CRYSTALS-Kyber)} \cite{kyber}: Key encapsulation mechanism
    \begin{itemize}
