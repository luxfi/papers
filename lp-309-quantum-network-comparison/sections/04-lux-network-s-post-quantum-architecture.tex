...
\begin{itemize}[nosep]
  ...
  \item \textbf{ML-DSA-65} (FIPS 204): NIST-standardized lattice-based
        ...
        hardness assumption.
  \item \textbf{Pulsar}: Module-LWE threshold signatures over the
        validator committee, byte-compatible with FIPS-204 ML-DSA
        verification. Post-quantum by construction.
\end{itemize}

The hybrid design provides defense in depth: if BLS is broken by a
quantum adversary, ML-DSA and Pulsar signatures on the same blocks
...
FROST and CGGMP21 threshold verification, Pulsar threshold verification,
