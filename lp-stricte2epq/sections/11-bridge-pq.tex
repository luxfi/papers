...
type BridgeProfile struct {
    ...
    RequireFinalityProof   bool  // every admission carries Pulsar cert
...
Every admission also carries a Pulsar-65 finality certificate
(Section~\ref{sec:pulsar}) over the source-chain block height the
...
Q-Chain Pulsar cert directly. For external chains, the bridge software
