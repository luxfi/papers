...
application range holds non-cryptographic adapters; the canonical DEX CLOB
receipt-settlement adapter at \texttt{0x9999} (the deprecated
\texttt{0x9010} aliases to it) is documented in
Section~\ref{sec:dex-adapter}.}
\end{table}
