...
%% ============================================================
\section{Corona: Threshold Lattice Signatures}

Corona is Lux Network's threshold signature scheme based on Ring-LWE. It allows
...
\begin{lstlisting}[language=Go,caption={Corona key generation via Shamir's secret sharing over $R_q$}]
