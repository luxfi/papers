...
Pulsar addresses this gap with a practical lattice-based threshold signature scheme
...
\item The Pulsar threshold signature scheme over Module-LWE (\S\ref{sec:scheme}).
