...
\begin{algorithm}[H]
\caption{Pulsar Signing --- Round 1 (Message-Independent)}
\label{alg:sign-r1}
\begin{algorithmic}[1]
...
\begin{algorithm}[H]
\caption{Pulsar Signing --- Round 2 (Message-Dependent)}
\label{alg:sign-r2}
\begin{algorithmic}[1]
