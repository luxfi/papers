...
\begin{itemize}[leftmargin=1.1em]
  ...
  \item \textbf{MPC Threshold Signers}: Distributed validator set with CGGMP21 (ECDSA), FROST (Schnorr/EdDSA), and Pulsar (post-quantum) threshold signatures
  ...
  \item \textbf{Quasar Verifier}: Hybrid BLS12-381 + Pulsar finality certificates
