...
Pulsar~\cite{pulsarrepo} is the Lux production fork of the threshold
...
\subsection{Corona: threshold R-LWE}

Corona~\cite{coronarepo,boschini2024corona} is a two-round lattice
...
in the random oracle model \cite{boschini2024corona}. The R-LWE
hardness is a separate algebraic-lattice assumption from the
M-LWE that backs ML-DSA: structural attacks against ideal-lattice
families have not transferred between R-LWE and M-LWE parameters
at production sizes \cite{albrechtestimator,bdgl2016}.

\subsection{Magnetar: threshold SLH-DSA}

Magnetar~\cite{magnetarrepo} is a threshold construction of FIPS 205
