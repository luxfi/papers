...
ML-DSA-65 signature, an optional Corona threshold R-LWE signature,
...
\item \texttt{Aurora} (intra-lattice, $\sim 37$ KB): adds R-LWE.
      Forging requires breaking both M-LWE and R-LWE.
...
\item Pulsar: \textbf{Tier A} (cut-ready for NIST MPTC v0.1
      ...
      APPROVED WITH GATES \cite{pulsarrepo}.
