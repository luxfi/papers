...
\item LP-073 / Pulsar~\cite{lp073,pulsarrepo} defines the threshold
      ML-DSA-65 primitive on its own terms (DKG, Sign1/Sign2/Combine,
      resharing, key-era lifecycle).
\item LP-073-Corona / Corona~\cite{boschini2024corona,coronarepo}
      defines the threshold R-LWE primitive (Lux production fork of
      Boschini et al.~ePrint 2024/1113).
\item Magnetar~\cite{magnetarrepo} defines the threshold SLH-DSA
...
boschini2024corona}). The Polaris profile demands a break of Magnetar
