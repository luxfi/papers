...
The CMP protocol achieves $(t,n)$-threshold unforgeability under the ECDSA security assumption, the Decisional Composite Residuosity (DCR) assumption for Paillier, and security of zero-knowledge proofs in the random oracle model.
\end{theorem}
...
\begin{theorem}[Pulsar Security]
Pulsar achieves existential unforgeability under the Module-LWE hardness assumption with parameters providing quantum security levels 1, 3, or 5 per NIST standards.
\end{theorem}
