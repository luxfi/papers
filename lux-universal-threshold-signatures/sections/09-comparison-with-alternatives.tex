...
\midrule
\textbf{Lux Threshold} & CMP, FROST, LSS, Doerner & \textbf{20+} & \textbf{Yes (LSS)} & \textbf{Yes (Pulsar)} & \textbf{8-40ms} & \textbf{Yes} & \textbf{2021-2025} \\
\bottomrule
\end{tabular}
...
\item \textbf{Post-Quantum Ready}: Pulsar lattice signatures vs. elliptic-curve only
