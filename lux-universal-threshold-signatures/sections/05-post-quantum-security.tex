...
\subsection{Pulsar Lattice-Based Signatures}

Pulsar provides quantum-resistant threshold signatures using Module-LWE hardness assumptions.
...
\paragraph{Chain Integration} Pulsar signatures can be verified on-chain via:
\begin{itemize}
...
Pulsar-128 & 45ms & 120ms & 35ms \\
Pulsar-192 & 68ms & 180ms & 52ms \\
Pulsar-256 & 95ms & 240ms & 70ms \\
\bottomrule
\end{tabular}
