...
standardization process~\cite{nist-pqc} selected ML-KEM (ML-KEM),
ML-DSA (ML-DSA), and SLH-DSA (SLH-DSA (FIPS 205, formerly SPHINCS+)) as the primary
replacements. Lux Network adopted these standards at the consensus
layer and extended them with ring-signature privacy (Pulsar) and
...
\begin{enumerate}[nosep]
  \item \textbf{Consensus signatures}: BLS-381 + ML-DSA-65 + Pulsar
