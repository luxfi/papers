...
\subsection{Pulsar upstream Feldman DKG is pseudoinverse-recoverable}

The upstream Pulsar academic reference uses a Feldman-style commit DKG that
...
This is documented; a chain operator who imports the upstream Pulsar
