...
\subsection{Ringtail upstream Feldman DKG is pseudoinverse-recoverable}

The upstream Ringtail academic reference uses a Feldman-style commit DKG that
has been shown pseudoinverse-recoverable in our internal red review
(\verb|luxcpp/crypto/ringtail/RED-DKG-REVIEW.tex|). Pulsar replaces this with
...
This is documented; a chain operator who imports the upstream Ringtail
...
The GPU code paths under \verb|ringtail/gpu/{metal,cuda,wgsl}/| (LP-137) are
