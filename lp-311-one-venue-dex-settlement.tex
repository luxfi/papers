...
via Lux Warp (the LP-225 cross-chain settlement spine), with the venue's own post-quantum consensus quorum certificate---not a bespoke
...
venue---settles across the boundary via Lux Warp. Settlement is asynchronous: the conduit escrows
...
prototyped and rejected after adversarial review found a value-blind certificate rebind and an
...
\bibitem{lp311} Z.~Kelling, ``LP-311: One-Venue DEX Settlement,'' Lux Proposals, 2026.
