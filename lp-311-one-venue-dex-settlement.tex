...
primary lane is a Corona (Ring-LWE) threshold group signature whose validity structurally implies
...
Because all chains settle to the same book, $\langle \mathit{native}, \mathrm{LUX}\rangle$ liquidity
is shared rather than fragmented per chain---the property a per-chain in-trie book cannot provide,
and a further reason the second book is removed.
