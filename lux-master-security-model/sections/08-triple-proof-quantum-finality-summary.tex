...
STARK-compressed ML-DSA & 200\,B & ${\sim}1$--$3$\,ms (CPU) & Lattice + Hash \\
Pulsar threshold (in STARK) & 0\,B (embedded) & 0\,$\mu$s (included) & Lattice \\
\midrule
...
\begin{itemize}[leftmargin=2em]
  ...
  \item Epoch proof generation: ${\sim}400$\,ms CPU / ${\sim}5$--$15$\,ms GPU (estimated) STARK prover~\cite{lux-benchmarks}.
