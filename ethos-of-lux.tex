...
FROST, and Corona~\cite{lux-corona} as independent protocol modules.
...
(ML-DSA, ML-KEM, Corona)~\cite{lp305} is deployed at the consensus layer, not
...
schemes (ML-DSA-65, SLH-DSA, Corona) are available as EVM
...
(Quasar~\cite{lp105}: BLS $\wedge$ ML-DSA $\wedge$ Corona, Christmas 2025).
...
Corona). \url{https://github.com/luxfi/consensus}.
