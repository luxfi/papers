...
engine sustains 104--126M byte-exact \texttt{uint256} fills per second on an
NVIDIA GB10 (6.9\,ns/match) and roughly 250M fills/s on an Apple M4 Max
(4.15\,ns/match), byte-identical to the CPU reference~\cite{lp306}. Quasar
