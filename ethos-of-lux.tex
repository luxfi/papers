...
(\texttt{luxfi/lattice}, August 2019), the quantum-resistant consensus
primitives, and the multi-party computation design. This revision adds,
...
FROST, and Corona as independent protocol modules.
...
(ML-DSA, ML-KEM, Corona) is deployed at the consensus layer, not
...
(Quasar: BLS $\wedge$ ML-DSA $\wedge$ Corona, Christmas 2025).
...
transactions across 15+ blockchain networks.
