...
\begin{lstlisting}[language=Java,caption=Core governance contract interface]
...
\begin{lstlisting}[language=Java,caption=Voting power calculation with reputation]
...
\begin{lstlisting}[language=Java,caption=Quantum-secure vote verification]
...
\begin{lstlisting}[language=Java,caption=Cross-chain governance bridge]
...
\begin{lstlisting}[language=Java,caption=Quantum-secure governance signature]
