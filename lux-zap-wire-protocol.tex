...
\begin{enumerate}
    ...
    \item \textbf{W3C DID identity}: Each watcher authenticates via a W3C Decentralized Identifier bound to an ML-DSA-65 post-quantum key pair, providing quantum-resistant identity independent of the Ed25519 transport signatures.
...
\bibitem{mpc} Kelling, Z. and Seesahai, V. \textit{Universal Threshold Signatures}. Lux Partners Limited, 2021.
\end{thebibliography}
