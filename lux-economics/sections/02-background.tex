...
\begin{itemize}[leftmargin=1.5em]
  ...
  \item An independent consensus instance (Quasar or custom);
...
LUX is the Primary Network staking and gas asset. Its protocol hard cap is
2 trillion LUX (the genesis \texttt{SupplyCap}); circulating supply grows along
the emission schedule of the Lux Tokenomics companion paper and remains far
within this cap.
