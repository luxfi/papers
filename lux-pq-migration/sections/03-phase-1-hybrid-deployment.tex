...
Pulsar key & Ring-LWE & 2,048 B & Per-epoch PQ anonymous threshold \\
\bottomrule
\end{tabular}
\end{center}
...
If either (a) the BLS discrete logarithm problem is hard, or (b) the Module-LWE problem (ML-DSA) and Ring-LWE problem (Pulsar) are hard, then the consensus mechanism is secure.
\end{theorem}
