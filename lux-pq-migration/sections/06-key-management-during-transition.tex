...
Pulsar & Ring-LWE & DKG shares & Per-epoch (automatic) & N/A (distributed) \\
\bottomrule
\end{tabular}
\end{center}
...
\item The \textbf{Pulsar key} is generated via DKG and rotated automatically each epoch. It is ephemeral.
\end{enumerate}
