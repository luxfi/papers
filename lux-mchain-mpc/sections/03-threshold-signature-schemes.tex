...
Pulsar & Lattice (LWE) & Quantum-safe & 7ms (15-of-21) \\
\bottomrule
\end{tabular}
...
\subsection{Pulsar: Post-Quantum Threshold}

Pulsar \cite{ntt-corona} provides lattice-based threshold signatures.
