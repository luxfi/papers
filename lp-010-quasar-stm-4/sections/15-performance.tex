...
Pulsar verify (per share)    & $7\,\mu\text{s}$ (placeholder) & $\mathbf{38\,\mu\text{s}}$ (real Ring-LWE) \\
Groth16 verify (per cert)      & $8\,\mu\text{s}$ (placeholder) & $\mathbf{62\,\mu\text{s}}$ (real Groth16) \\
Cert lanes per round           & 1 (BLS only) & $\mathbf{3}$ (BLS + Pulsar + Groth16) \\
...
Pulsar share (per share)     & $24\,\mu\text{s}$ \\
