...
\begin{enumerate}[nosep]
  ...
  \item \textbf{Biometric + FHE fusion}: WebAuthn PRF provides
        passkey-derived keys; regulated custodians supply biometric
        KYC attestations. The missing piece is encrypting the
        biometric template under TFHE so the server can \emph{match}
        without seeing the template.
\end{enumerate}
