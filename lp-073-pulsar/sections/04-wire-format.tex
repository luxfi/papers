...
\item The SHA-256 of every payload (each individually serialized via \textsc{WriteTo}) MUST match across the Go canonical, the C++ port, and any GPU kernel claiming Ringtail compatibility.
\end{enumerate}
