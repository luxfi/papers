...
on a regulated EVM L1 (chain IDs 8675309--8675311) for an ATS handling
...
\input{sections/03-correctness-properties}
\input{sections/04-worm-audit-trail}
\input{sections/05-architecture-details}
\input{sections/06-resilience-analysis}
