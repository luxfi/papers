...
floor numbers), realistic securities-style workload mix.
...
bench addendum once the production regulated securities L1 validator profile ships.
...
On a 64-core box (production regulated securities L1 validator): expected
...
execution measurement was run on the 2026-06-04 bench cluster (the
...
addendum once the production regulated securities L1 validator profile ships.
