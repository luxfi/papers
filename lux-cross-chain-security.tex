...
\item \textbf{Post-quantum security}: $C$ inherits triple-proof quantum finality from the primary network validators' ML-DSA and Corona keys.
...
Finality reversion & Break BLS + ML-DSA + Corona & Computationally infeasible \\
