...
\midrule
P-Chain & Validator management, staking & Platform VM & Snowman & 1s \\
X-Chain & Asset creation, UTXO transfers & AVM (DAG) & Avalanche & Sub-second \\
C-Chain & EVM smart contracts & EVM & Snowman & 1s \\
\bottomrule
\end{tabular}
\end{center}
