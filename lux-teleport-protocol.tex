...
All (PQ) & Corona & 15-of-21 & $< 2^{-128}$ (LWE) \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{itemize}
    \item \textbf{Lean~4} (18 files at \texttt{github.com/luxfi/formal}): BLS aggregation soundness, FROST threshold correctness, Corona LWE security, Warp message delivery and ordering guarantees.
