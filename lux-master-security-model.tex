...
lattice for ML-DSA and Ringtail, hash for STARK proofs). We prove that any two of the
...
\textbf{Case 2: Lattice assumptions break.} ML-DSA and Ringtail signatures can be
...
Privacy & Anonymous validator votes & Ring-LWE (Ringtail) & [Assumed] \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{enumerate}[leftmargin=2em]
  ...
  \item \textbf{Ringtail threshold signature} (embedded in STARK): Anonymous
...
Ringtail EUF-CMA & [Proven] & ROM proof under Module-LWE \\
...
Ringtail threshold (in STARK) & 0\,B (embedded) & 0\,$\mu$s (included) & Lattice \\
\midrule
