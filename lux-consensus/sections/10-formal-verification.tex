...
\item \textbf{Crypto}: Axiomatization of BLS, FROST, Pulsar, and ML-DSA
...
LWE for Pulsar) and probabilistic sampling properties that are established by
...
The Quasar model captures the dual BLS + Pulsar signature requirement for
...
\paragraph{Pulsar post-quantum signatures.}
The Pulsar lattice-based threshold scheme is axiomatized with LWE parameters
