...
primitive introduced as ``Corona'' by Boschini, Kaviani, Lai,
Malavolta, Takahashi, and Tibouchi~\cite{boschini2024corona},
...
its Corona upstream while distinguishing the Lux upstream-tracker
from production deployments.

\section{Construction summary}
\label{sec:construction}

Annulus follows the original Corona construction~\cite{boschini2024corona}:
...
\item \textbf{Trusted-dealer DKG.} The academic Corona
...
upstream and ships KAT vectors against the original Corona
...
\texttt{0x0802} is named \texttt{Corona} (wire-stable; do not
...
are byte-stable against the upstream Corona reference. Corona's
...
M.~Tibouchi.
\newblock Corona: Practical two-round threshold signatures from
