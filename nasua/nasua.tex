...
\begin{abstract}
Nasua is the Lux name for the Ring-LWE 2-round threshold-signature
...
Nasua is \emph{not enabled} in Lux production. The production
R-LWE path is \emph{Corona}~\cite{corona}, a hardened fork of
Nasua that switches the hash family to SHA-3 / SP~800-185, adds
...
Nasua follows the original Ringtail construction~\cite{boschini2024ringtail}:
