...
\begin{lstlisting}[language=text,caption={Hybrid identity wire layout.}]
PQ-RNS Identity ::= {
...
\begin{lstlisting}[language=text,caption={Hybrid link-establishment packets.}]
LinkRequest ::= {
...
channel.} \url{https://github.com/luxfi/zwing}
