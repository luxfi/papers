...
A block is final when the Z-Chain receipt attests to valid signatures from all three paths with $\geq 67\%$ validator agreement on each. Under the assumption that at least one of BLS12-381, Ringtail-LWE, or ML-DSA~\cite{lux-pq} remains secure, finality cannot be forged.
\end{theorem}
