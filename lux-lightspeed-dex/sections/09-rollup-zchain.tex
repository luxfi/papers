...
new trades are matched, which is the per-device figure of Section~\ref{sec:gpu-matching}
(billions of orders/sec per device---9.13\,B on a GB10, 12.76\,B on an AMD Radeon 8060S---aggregated linearly across a fleet).
