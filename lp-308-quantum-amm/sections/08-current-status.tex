...
\begin{itemize}[nosep]
  ...
  \item \textbf{CLOB engine} (\texttt{luxfi/dex}) provides billions of
        byte-exact \texttt{uint256} orders/sec of GPU-accelerated matching
        (9.13\,B/s on an NVIDIA GB10, 12.76\,B/s on an AMD Radeon 8060S,
        5.60\,B/s on an Apple M4 Max), used as the primary exchange engine.
