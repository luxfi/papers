...
\textbf{Lux choice}: ML-DSA for balance of size and performance, SLH-DSA for stateless long-term security.
...
\textbf{Hardness}: No known quantum algorithm solves MLWE faster than classical lattice reduction ($2^{128}$ security).
...
\textbf{Key property}: Metastability-based consensus (unlike Nakamoto or BFT).
