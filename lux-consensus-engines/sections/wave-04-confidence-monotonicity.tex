...
\label{eq:wave-supermajority}
\end{equation}

\begin{lemma}[Supermajority Amplification]
\label{lem:wave-amplification}
...
$q_0 = \Phi(1 - p_1, k, \alpha)$. Since $p_1 > 1/2 + \gamma$, by Lemma~\ref{lem:wave-amplification},
...
\label{eq:wave-population}
\end{equation}

\begin{theorem}[Exponential Convergence]
\label{thm:wave-convergence}
...
\begin{proof}
Define $\epsilon_r = p_r - 1/2$. The map in Equation~\ref{eq:wave-population} satisfies, for
