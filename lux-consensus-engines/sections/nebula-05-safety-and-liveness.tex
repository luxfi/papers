...
\label{sec:nebula-safety}

\begin{theorem}[Nebula Safety]
\label{thm:nebula-nebula-safety}
...
\label{lem:nebula-nebula-liveness}
...
takes $O(\log n / \xi)$ rounds (Theorem~\ref{thm:nebula-nebula-convergence}), and the
