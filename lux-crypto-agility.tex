...
\texttt{SIG\_CORONA} & Corona threshold & Active & 128-bit PQ \\
...
During the transition from classical to post-quantum signatures, Lux uses a hybrid approach: each block carries both a classical (BLS) and a post-quantum (ML-DSA or Corona) signature. This is the foundation of Quasar's triple-proof finality \cite{quasar}.
