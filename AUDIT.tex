...
\item \texttt{lux-quantum-consensus.tex} --- PQ secure multi-consensus with Dilithium/Kyber/SPHINCS+. 557 lines.
\item \texttt{lp-105-quasar-consensus.tex} --- LP-105: Quasar formal specification (BLS + Corona + ML-DSA). 1398 lines. Canonical LP.
\item \texttt{lp-307-quantum-consensus-protocol.tex} --- LP-307: Eisenstein-series quantum consensus (research direction). 465 lines.
\item \texttt{lux-triple-proof-consensus.tex} --- Triple-proof quantum finality (BLS + STARK-ML-DSA + Corona). 323 lines.
...
\item \texttt{lux-corona-pq.tex} --- Corona: lattice-based threshold signatures. 480 lines.
...
\item \texttt{lux-.tex} --- Tokenized validator positions. 904 lines.
...
identical author (Antje Worring, Zach Kelling), identical date (2025). A byte-level diff
...
\item \texttt{lux-consensus.tex} (1622 lines) --- the comprehensive canonical
      ...
      with Lean 4 proofs.
\item \texttt{lp-105-quasar-consensus.tex} (1398 lines) --- the formal LP
...
\item \verdict{lux-quasar-consensus.tex} (701 lines) --- an earlier, less
      formal treatment of Quasar. Superseded by LP-105. Claims ``4,761,904 TPS
...
\item \verdict{lux-quantum-consensus.tex} (557 lines) --- early 2022 paper
      ...
      and ``50,000+ TPS.'' Superseded by LP-105 and LP-307. Contains Keywords
...
\item \texttt{lux-triple-proof-consensus.tex} (323 lines) --- focused on the
      BLS + STARK-ML-DSA + Corona triple-proof mechanism. Uses non-standard
      preamble (see \S\ref{sec:structure}). Could be merged into LP-105.
\end{itemize}
...
\texttt{lux-.tex} & 904 & 15 & ``comprehensive,'' ``innovative,'' ``seamless,'' ``ecosystem'' (14 uses) \\
...
\item \texttt{lux-quasar-consensus.tex} --- superseded by lp-105-quasar-consensus.tex. Contains unsubstantiated ``4.7M TPS'' claim.
\end{enumerate}

\subsection{MERGE (4 actions)}

\begin{enumerate}
\item Merge \texttt{lux-quantum-consensus.tex} into \texttt{lp-105-quasar-consensus.tex} --- the LP is the canonical Quasar spec; the 2022 paper adds nothing the LP does not cover.
...
\item \texttt{lux-.tex} --- 15 slop-word hits, 14 uses of ``ecosystem.'' Tighten language.
\end{enumerate}
