...
\begin{description}[nosep,leftmargin=0pt]
  ...
  \item[Q-Chain (Quantum)] Manages post-quantum threshold signatures
        via Corona (Module-LWE threshold sigs~\cite{corona}) and
...
Application developers deploy sovereign L1 chains via the P-Chain. Each chain chooses its own VM, validator set,
