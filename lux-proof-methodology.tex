...
Lux Network makes specific security claims: Quasar provides safety under $f < n/3$ Byzantine validators \cite{quasar}, Pulsar provides 128-bit post-quantum security \cite{ringtail}, FHE provides IND-CPA security under LWE hardness \cite{tfhe}. Each of these claims carries a proof obligation---a verification artifact that demonstrates the claim holds, not just a prose argument in a paper.
