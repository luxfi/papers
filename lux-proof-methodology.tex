...
Corona threshold scheme & T1+T2 & Novel construction, PQ claims \\
...
\item \textbf{Corona Threshold Signing}: Verify unforgeability under concurrent sessions with a network adversary.
\end{enumerate}
...
Cryptography (Corona, FHE) & 1 audit + 1 academic review \\
