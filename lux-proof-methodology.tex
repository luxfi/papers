...
Ringtail threshold scheme & T1+T2 & Novel construction, PQ claims \\
...
\item \textbf{Ringtail Threshold Signing}: Verify unforgeability under concurrent sessions with a network adversary.
\end{enumerate}
...
Cryptography (Ringtail, FHE) & 1 audit + 1 academic review \\
