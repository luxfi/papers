...
\bibitem{kcchubuffer}
Chu, K.C. (2024).
\textit{buffer-benchmarks: Benchmarking Protobuf, FlatBuffers, and Cap'n Proto on Go and Rust}.
\url{https://github.com/kcchu/buffer-benchmarks}

\bibitem{chronoxorbench}
chronoxor. (2024).
\textit{CppSerialization: Performance comparison of C++ serialization protocols (Cap'n Proto, FBE, Flatbuffers, Protobuf, JSON)}.
\url{https://github.com/chronoxor/CppSerialization}

\bibitem{grpcperformance}
gRPC Authors. (2024).
\textit{gRPC Performance Benchmarks}.
